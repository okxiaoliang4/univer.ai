...
2. [Univer Architecture](/guides/sheets/architecture/univer) to learn more about Univer's architecture design.
...
3. [Univer Sheet API](/guides/sheets/features/core/sheet-api)
4. [Univer Doc API](/guides/docs/facade/doc-api)
