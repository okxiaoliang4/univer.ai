...
<Cards>
  <Cards.Card icon="📝" title="文档" href="/guides/docs"></Cards.Card>
  <Cards.Card icon="📊" title="电子表格" href="/guides/sheets"></Cards.Card>
</Cards>
...
请参阅 [技术栈与兼容性说明](/introduction/compatibility) 页面。
...
[Univer OSS 的代码](https://github.com/dream-num/univer)在 Apache-2.0 协议下开源，任何组织和个人都可以免费使用其源代码和 npm 包。
