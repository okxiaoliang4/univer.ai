...
2. [Univer 架构](/guides/sheets/architecture/univer) 详细了解 Univer 的架构设计
...
1. 电子表格的快照格式是 [`IWorkbookData`](/typedoc/@univerjs/core/interfaces/IWorkbookData)
  1. [单元格数据结构](guides/sheet/getting-started/cell-data) 介绍了单元格的数据结构
...
4. [Univer Doc API 常用方法](/guides/docs/facade/doc-api)
5. [Facade API 参考手册](/typedoc/@univerjs/facade/README)
