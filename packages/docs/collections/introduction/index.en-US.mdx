...
<Cards>
  <Cards.Card icon="📝" title="Documents" href="/guides/docs"></Cards.Card>
  <Cards.Card icon="📊" title="Spreadsheets" href="/guides/sheets"></Cards.Card>
</Cards>
...
Please refer to our [Tech Stack & Compatibility Statement](/introduction/compatibility) for more information.
...
The code of Univer OSS, available on [GitHub](https://github.com/dream-num/univer), is open source under the Apache-2.0 license. Organizations and individuals are free to use its source code and npm package.
