...
- **🔰 Installation & Usage**: If you want to learn how to manually set up a Univer project from scratch, check out the [Installation & Usage](/guides/docs/getting-started/installation) chapter. It will guide you through the process step by step.
