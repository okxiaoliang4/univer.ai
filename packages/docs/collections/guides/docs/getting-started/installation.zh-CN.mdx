...
<Callout type="info" emoji="🍃">
  如果你是首次使用 Univer，我们推荐从 Presets 开始。在后续的小节中，除非特殊说明，我们都会假设你使用了 Presets。如果你已经较为熟悉 Univer，并且希望更加灵活地引入插件（例如懒加载部分插件），可以参考 [高级安装方式](/guides/docs/advanced-installation)。
</Callout>
