...
![Missing Locale](./introduction//pivot.png)

## Data Source

In Univer Sheet, the data source for a pivot table can be a worksheet or a data range. You can choose different data sources as needed to better analyze the data.
