import { Cards, Card, Callout, Steps, Tabs } from 'nextra/components'
...
- **🔰 Installation & Usage**: If you want to learn how to manually set up a Univer project from scratch, check out the [Installation & Usage](/guides/sheets/getting-started/installation) chapter. It will guide you through the process step by step.
