...
If you are using Univer for the first time, we recommend starting with Presets. In this chapter, we will introduce how to install Univer with Presets. If you are familiar with Univer or want to import plugins more flexibly (e.g., lazy loading some plugins), you can refer to the [Advanced Installation](/guides/sheets/getting-started/advanced-installation) chapter.
