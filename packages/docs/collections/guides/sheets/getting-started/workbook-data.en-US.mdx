...
1. [Creating a univer-Sheet using IWorkbookData](/guides/sheets/facade/sheet-api#creating-a-workbook)
2. [Saving IWorkbookData from univer-Sheet](/guides/sheets/facade/sheet-api#getting-workbook-data)
