...
Univer's core framework and many basic features are [open source on GitHub](https://github.com/dream-num/univer), and are licensed under the Apache-2.0 license for free use by individuals and organizations. At the same time, we provide a series of advanced features for enterprise users, including: 
...
Some advanced features require access to the Univer server, including:
