...
Full Univer advanced features require license support. You can activate paid plans by adding a license to your project, or you can upgrade to a higher-level plan by updating your license. This page will guide you on how to obtain, configure, and verify licenses.

## Prerequisites
Before you begin, make sure you:
- Have integrated Univer advanced features in your project. If you haven't completed the integration, please refer to [Integrating Univer Advanced Features](/guides/sheets/getting-started/quickstart#integration-advanced-features).
...
If you don't have a license or are still considering whether to purchase, we have prepared a 30-day trial license for you to fully experience all advanced features of Univer.
...
## Related Links
- [Integrating Univer Advanced Features](/guides/sheets/getting-started/quickstart#integration-advanced-features)
