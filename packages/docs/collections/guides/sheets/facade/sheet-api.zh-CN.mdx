...
[`workbookData`](/guides/sheets/getting-started/cell-data) 是一个对象，包含了工作簿的配置信息。
...
### [行列操作](/guides/sheets/features/core/row-column)

### [范围Range](/guides/sheets/features/core/range-selection#范围range)

### [选区Selection](/guides/sheets/features/core/range-selection#选区selection)

### [单元格Cell](/guides/sheets/features/core/range-selection#单元格cell)

### [冻结](/guides/sheets/facade/freeze)

### [集成自定义组件](/guides/sheets/facade/dom)
...
导入 API 需要使用[服务端版本 Facade API](/zh-CN/guides/sheets/getting-started/facade#与服务端配合使用) 调用 [导入导出插件](/zh-CN/guides/sheets/features/import-export) 提供的功能，使用前确保已经引入对应的依赖。
...
导出 API 需要使用[服务端版本 Facade API](/zh-CN/guides/sheets/getting-started/facade#与服务端配合使用) 调用 [导入导出插件](/zh-CN/guides/sheets/features/import-export) 提供的功能，使用前确保已经引入对应的依赖。
...
可参考[获取工作簿数据](/guides/sheets/facade/sheet-api#获取工作簿数据)获取 `IWorkbookData` 格式的数据。
