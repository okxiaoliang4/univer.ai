...
| | Univer | Luckysheet |
|-------|----------------|------------|
| Number Format | [numfmt](/guides/sheets/features/numfmt), Configure via [Cell Style](/guides/sheets/getting-started/cell-data#cell-style)  | [Cell format: cell.ct](https://dream-num.github.io/LuckysheetDocs/guide/cell.html#cell-format)  |
