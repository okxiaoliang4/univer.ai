...
关于插件的生命周期的更多信息，可以查看 [插件生命周期](/guides/sheets/architecture/univer#%E6%8F%92%E4%BB%B6%E7%94%9F%E5%91%BD%E5%91%A8%E6%9C%9F) 了解更多。
...
<Callout type="info" emoji="ℹ️">
  ...
  如果你想了解更多关于命令的内容，可以查看 [命令系统](/guides/sheets/architecture/univer#命令系统) 了解更多。
</Callout>
...
随着插件的规模增加，推荐进一步了解[模块分层](/guides/sheets/architecture/univer#模块分层)的最佳实践。

Univer 生态还处于起步阶段，如果你有任何问题或者建议，欢迎提交 PR 或者 Issue。

## 参考文档

- [插件生命周期](/guides/sheets/architecture/univer#插件生命周期)
