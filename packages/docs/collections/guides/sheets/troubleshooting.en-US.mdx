...
<Callout type="info" emoji="ℹ️">
    Data collection is only effective for free version or 30-day trial version, and the commercial version will not report any data from your server.</Callout>
