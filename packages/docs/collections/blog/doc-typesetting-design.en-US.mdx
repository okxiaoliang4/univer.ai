...
![Overall Architecture Diagram](./doc-typesetting-design/0.png)
...
![DOM tree](./doc-typesetting-design/1.png)
...
![Univer rendering node objects](./doc-typesetting-design/2.png)
