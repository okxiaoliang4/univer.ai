...
![The state transition diagram of the state machine](./ot/6.png)
...
<p className="text-gray-500 text-sm mt-8">Author: [Wenzhao Hu](https://github.com/wzhudev), Tech Leader of Univer</p>
