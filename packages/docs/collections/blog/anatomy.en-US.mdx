...
<Callout type="info" emoji="💡">
  Learn about Univer's [layered model](/guides/sheets/architecture/univer#divide-modules-by-layers-on-the-architecture).
</Callout>
...
<Callout type="info" emoji="💡">
  Learn about the concept of [snapshots](/guides/sheets/getting-started/concepts#snapshots).
</Callout>
...
<Callout type="info" emoji="💡">
  Read about the [Command System](/guides/sheets/architecture/univer#command-system) to understand what commands are and the three types of commands.
</Callout>
...
<Callout type="info" emoji="💡">
  Please read [Architecture of Rendering Engine](/guides/sheets/architecture/rendering) to understand how to write rendering layer code.
</Callout>
...
<Callout type="info" emoji="💡">
  For more information on Univer's lifecycle mechanism, please refer to the documentation on [Plugin Lifecycle](/guides/sheets/architecture/univer#plugin-lifecycle).
</Callout>

<Callout type="info" emoji="💡">
  Univer uses the dependency injection pattern to manage dependencies between modules and instantiate modules. For more information on dependency injection, please refer to our [documentation](/guides/sheets/architecture/univer#dependency-injection).
</Callout>
